        ...
        public update(passedTime: number): void {
            ...
            if (!this.bone._blendDirty) {
                ...
                if (weight >= 0.0) {
                    ...
                    this._boneTransform.skewX = Transform.normalizeRadian(this._boneTransform.skewX);
                    this._boneTransform.skewY = Transform.normalizeRadian(this._boneTransform.skewY);
                }
            }
